        ...
        <table className="min-w-full text-sm text-left">
          <thead className="bg-[#F3F6FD] text-gray-700">
            <tr>
              ...
              <th className="px-9 py-3 whitespace-nowrap">Jabatan</th>
              <th className="px-7 py-3 whitespace-nowrap">Nip</th>
              <th className="px-4 py-3 whitespace-nowrap">Tempat Tanggal Lahir</th>
          ...
          <tbody>
            {filteredGuru.map((guru, i) => (
              <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-[#F9FBFF]'}>
                ...
                <td className="px-9 py-2 whitespace-nowrap">{guru.jabatan}</td>
                <td className="px-7 py-2 whitespace-nowrap">{guru.nip}</td>
                <td className="px-4 py-2 whitespace-nowrap">{guru.ttl}</td>
                <td className="px-4 py-2 whitespace-nowrap">{guru.jenisKelamin}</td>
              </tr>
            ))}
          </tbody>
        </table>
...
// Todo: tambahkan halaman tambah guru dan hapus
