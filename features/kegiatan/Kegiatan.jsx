  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full p-4 sm:p-8 bg-gray-50">
      <div className="flex-1 p-4 sm:p-6 bg-[#F5F6FA] min-h-screen w-full">
        ...
        {/* Versi Desktop */}
        <div className="overflow-x-auto rounded-md bg-white shadow hidden sm:block">
        ...
        <div className="block sm:hidden space-y-4">
          {dataKegiatan.map((kegiatan, i) => (
            ...
            >
              <p className="text-base font-semibold">{kegiatan.judul}</p>
              <p className="text-sm text-gray-600">Tanggal: {kegiatan.tanggal}</p>
              <p className="text-sm text-gray-600">Deskripsi: {kegiatan.deskripsi}</p>
...
// Todo: Tambahkan halaman untuk melihat lengkap tiap baris dan tambahkan halaman tambah kegiatan dan hapus
